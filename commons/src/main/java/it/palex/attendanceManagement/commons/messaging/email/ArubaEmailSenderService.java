...
public class ArubaEmailSenderService implements EmailSenderService {

	private static final Logger logger = LogManager.getLogger(ArubaEmailSenderService.class);
	...
	public ArubaEmailSenderService() {
	}
