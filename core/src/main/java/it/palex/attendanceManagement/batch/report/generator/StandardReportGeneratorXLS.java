...
public class StandardReportGeneratorXLS extends StandardExcelReportGeneratorAbstract implements ReportGenerator {
	...
	public Pair<InputStream, String> generateReport(UserProfile profile, List<CompletedTask> completedTasksOfUserInMonth, 
		...
		return Pair.of(fileStream, MultipleDocumentBuilderFactory.XLSBuilderID);
	}
