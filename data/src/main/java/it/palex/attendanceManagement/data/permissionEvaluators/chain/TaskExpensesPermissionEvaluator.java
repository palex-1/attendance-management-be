...
@Component
public class TaskExpensesPermissionEvaluator implements ChainPermissionEvaluatorComponent {

    public static final String PERMISSION_TO_CHECK = "TASK_EXPENSES";

    @Autowired
    private BudgetSummaryPermissionEvaluator nextInChain;
