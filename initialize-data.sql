...
INSERT INTO GLOBAL_CONFIGURATIONS(SETTING_AREA, SETTING_KEY, SETTING_VALUE, VISIBLE, EDITABLE)
VALUES( 'BADGE', 'COMPANY_NAME', 'Free Software', TRUE, TRUE);


INSERT INTO DOCUMENT (description,file_manager,file_path,full_file_name, file_size) VALUES
('LOGO_IMAGE_a7209a8c-7f73-4ddd-abfb-179659ade4df', 'StandardFSFileManager', 'C:/CustomTempData/AttendanceManagement_Files/SYSTEM/company_logo.png','company_logo.png', 10193);

INSERT INTO GLOBAL_CONFIGURATIONS(SETTING_AREA, SETTING_KEY, VISIBLE, EDITABLE, SETTING_VALUE)
select 'BADGE', 'COMPANY_LOGO_DOCUMENT_ID', TRUE, TRUE, id from document where description='LOGO_IMAGE_a7209a8c-7f73-4ddd-abfb-179659ade4df';
...
INSERT INTO permission_group_label(NAME) values ('STAGIST_EMPLOYEE');
INSERT INTO permission_group_label(NAME) values ('JUNIOR_EMPLOYEE');
INSERT INTO permission_group_label(NAME) values ('SENIOR_EMPLOYEE');
...
INSERT INTO PERMISSION_GROUP(NAME, FK_AUTHORITY) VALUES ('STAGIST_EMPLOYEE', 'LOGGED_USER_PERMISSION');
INSERT INTO PERMISSION_GROUP(NAME, FK_AUTHORITY) VALUES ('STAGIST_EMPLOYEE', 'INCARICO_READ');



INSERT INTO PERMISSION_GROUP(NAME, FK_AUTHORITY) VALUES ('JUNIOR_EMPLOYEE', 'LOGGED_USER_PERMISSION');
INSERT INTO PERMISSION_GROUP(NAME, FK_AUTHORITY) VALUES ('JUNIOR_EMPLOYEE', 'INCARICO_READ');


INSERT INTO PERMISSION_GROUP(NAME, FK_AUTHORITY) VALUES ('SENIOR_EMPLOYEE', 'LOGGED_USER_PERMISSION');
INSERT INTO PERMISSION_GROUP(NAME, FK_AUTHORITY) VALUES ('SENIOR_EMPLOYEE', 'INCARICO_READ');
...
INSERT INTO USERS_AUTH_DETAILS( USERNAME, HASHED_PASSWORD, LAST_PASSWORD_CHANGE_DATE, ISENABLED, 
 ...
 CURRENT_TIMESTAMP at time zone 'utc', true, true, true, true, false, 'ADMINISTRATION', true);	
